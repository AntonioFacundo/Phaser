var menuState = {
	create: function() { 
		...
		if (!localStorage.getItem('bestScore3')) { 
		// Then set the best score to 0 
		localStorage.setItem('bestScore3', 0); }
		// If the score is higher than the best score 
		if (game.global.score > localStorage.getItem('bestScore3')) { 
		// Then update the best score 
		localStorage.setItem('bestScore3', game.global.score);
		}
		...
		var nameLabel = game.add.text(game.world.centerX, -30, 'IT S!!', { font: '50px Arial', fill: '#ffffff' }); 
		nameLabel.anchor.setTo(0.5, 0.5);
		// Show the score at the center of the screen 
		var text = 'Score: ' + game.global.score + '\nBest score: ' + localStorage.getItem('bestScore2'); 
		var scoreLabel = game.add.text(game.world.centerX, game.world.centerY, text, { font: '25px Arial', fill: '#ffffff', align: 'center' }); scoreLabel.anchor.setTo(0.5, 0.5);
		...
		if (game.device.desktop) { 
			var text2 = 'Presiona UP'; 
		} else {
			var text2 = 'Touch the screen to start'; 
		}
		...
		var startLabel3 = game.add.text(game.world.centerX -230, game.world.height-30, 'Press x to mute', { font: '10px Arial', fill: '#ffffff' }); 
		startLabel.anchor.setTo(0.5, 0.5);
		...
		// Create the tween var tween = game.add.tween(startLabel);
		...
		game.camera.x = game.world.centerX - 230;
		game.camera.y = game.world.height-30;
	},
	start: function() { 
